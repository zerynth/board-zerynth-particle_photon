...
#define VM_OTA_RECORD 0x8006000
#define VM_OTA_VM_ADDR(idx) ( ((idx)%(VM_OTA_MAX_VM)) ? (0x800C000):(0x8020000))
#define VM_OTA_BYTECODE(idx) ( ((idx)%(VM_OTA_MAX_BC)) ? (0x80A0000):(0x8040000))
